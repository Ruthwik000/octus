                  ...
                  <div className="flex items-center justify-between mb-4">
                    <div>
                      <h3 className="text-lg font-semibold text-white">
                        {suite.component || 'Test Suite'} — {suite.total_cases} cases
                      </h3>
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          {runStatus.status === 'queued' && (
                            <><Clock className="w-4 h-4 text-violet-400 animate-pulse" />
                              <span className="text-sm font-medium text-violet-400">Queued — waiting for runner...</span></>
                          )}
                              ...
                              <tbody className="divide-y divide-dark-800">
                                {tc.steps?.map((step) => (
                                  <tr key={step.step_number} className="hover:bg-dark-900/50">
                                    ...
                                    <td className="px-3 py-2.5 text-dark-400 font-mono text-xs">{step.input_data || '—'}</td>
